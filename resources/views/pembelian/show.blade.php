...
@section('breadcrumb', 'Transaksi / Pembelian / Detail')

@section('content')
<div class="card-erp" style="margin-bottom:24px;">
    <div class="card-erp-header">
        <h2 class="card-erp-title">Faktur: {{ $pembelian->kode_faktur }}</h2>
        <div>
    ...
    <div class="card-erp-body">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px;">
            <div>
                <table style="width:100%;font-size:14px;border-spacing:0 8px;">
                    <tr><td style="color:#64748b;width:120px;">Tanggal</td><td>: <strong>{{ $pembelian->tanggal->format('d/m/Y') }}</strong></td></tr>
                    ...
                    <tr><td style="color:#64748b;">Status</td><td>: 
                        ...
                        @else
                            <span class="badge-erp badge-warning">Kredit (Hutang)</span>
                        @endif
                    </td></tr>
                </table>
            </div>
            <div>
                <table style="width:100%;font-size:14px;border-spacing:0 8px;">
                    <tr><td style="color:#64748b;width:120px;">Total Tagihan</td><td class="money" style="font-size:16px;">: <strong>Rp {{ number_format($pembelian->total_harga,0,',','.') }}</strong></td></tr>
                    <tr><td style="color:#64748b;">Total Dibayar</td><td class="money" style="color:#16a34a;">: Rp {{ number_format($pembelian->total_dibayar,0,',','.') }}</td></tr>
                    <tr><td style="color:#64748b;">Sisa Hutang</td><td class="money" style="color:#dc2626;">: Rp {{ number_format($pembelian->sisa_hutang,0,',','.') }}</td></tr>
                </table>
            </div>
        </div>
        ...
        <h3 style="font-size:15px;margin-bottom:12px;color:var(--brand-dark);">Detail Item Masuk</h3>
        <table class="table-erp">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="money">Rp {{ number_format($item->harga_beli,0,',','.') }}</td>
                    <td>{{ $item->jumlah }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="money" style="font-weight:bold;font-size:16px;">Rp {{ number_format($pembelian->total_harga,0,',','.') }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
...
<div class="card-erp">
    ...
    <div class="card-erp-body" style="padding:0;">
        <table class="table-erp">
            ...
            <tbody>
                @forelse($pembelian->coaLogs as $log)
                <tr>
